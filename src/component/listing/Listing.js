        ...
        <div className='mt-3'>
            {
                Data.map((i, index) => {
                    return (
                        <div className='listing-card' onClick={()=>Navigate('/add-expense')} style={{ backgroundColor: index % 2 == 1 ? 'rgba(137, 187, 238, 0.261)' : '', borderTop: index % 2 == 1 ? '1px solid rgba(128, 128, 128, 0.504)' : '', borderBottom: index % 2 == 1 ? '1px solid rgba(128, 128, 128, 0.504)' : '' }}>
